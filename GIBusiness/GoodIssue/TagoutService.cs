...
namespace GIBusiness.GoodIssue
{
    public class TagoutService
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        cmd1 += "       Update WMSDB_AMZ_Outbound_V3..wm_TagOutitem set                           ";
                        cmd1 += "            TagOut_No = '0000B' + SUBSTRING(TagOut_No, 6, 20)                           ";
                        cmd1 += "        where TagOut_Index   in   (                                                      ";
                        cmd1 += "                                select    TagOut_Index                                                  ";
                        cmd1 += "                                from WMSDB_AMZ_Outbound_V3..wm_TagOutitem                               ";
                        ...
                        cmd2 += "       Update WMSDB_AMZ_Outbound_V3..wm_TagOutitem set                           ";
                        cmd2 += "            TagOut_No = '0000A' + SUBSTRING(TagOut_No, 6, 20)                           ";
                        cmd2 += "        where TagOut_Index   in   (                                                      ";
                        cmd2 += "                                select    TagOut_Index                                                  ";
                        cmd2 += "                                from WMSDB_AMZ_Outbound_V3..wm_TagOutitem                               ";
                        ...
                        cmd3 += "       Update WMSDB_AMZ_Outbound_V3..wm_TagOutitem set                           ";
                        cmd3 += "            TagOut_No = '0000A' + SUBSTRING(TagOut_No, 6, 20)                           ";
                        cmd3 += "        where TagOut_Index   in   (                                                      ";
                        cmd3 += "                                select    TagOut_Index                                                  ";
                        cmd3 += "                                from WMSDB_AMZ_Outbound_V3..wm_TagOutitem                               ";
        ...
        public bool maketagOut_V3(findtagViewModelItem data)
        {
            String State = "Start";
            String msglog = "";
            var olog = new logtxt();
            olog.logging("maketagOut_V3", State);
            ...
            try
            {
                ...
                //olog.logging("maketagOut_V3", "Check WM_TagOut");

                //var listTAGOUT = db.WM_TagOut.Where(c => c.Ref_Document_No == data.GoodsIssue_No ).ToList();

                //if (listTAGOUT.Count() != 0 )
                //{
                //    olog.logging("maketagOut_V3", "listTAGOUT Have to DATA ");

                //    return false;
                //}

                olog.logging("maketagOut_V3", "get sp_CheckB4Tote");
                ...
                foreach (var item in CheckB4ToteResult)
                {
                    if (item.CountRows > 0)
                    {
                        ...
                        //return resultWave;
                        olog.logging("maketagOut_V3", "sp_CheckB4Tote : " + item.msgCheck.ToString ());
                        return false;
                    }
                ...
                olog.logging("maketagOut_V3", "get IM_GoodsIssueItemLocation");
                ...
                olog.logging("maketagOut_V3", "GrouplistGIL : " + GrouplistGIL.Count().ToString ());
                ...
                foreach (var item in GrouplistGIL)
                {
                    ...
                    olog.logging("maketagOut_V3", "PlanGI NO : " + item.RefDocNo);
                    ...
                    olog.logging("maketagOut_V3", "select 1 : " + item.RefDocNo);
                    ...
                    //------------------------------------------------------------------------------------------------//
                    olog.logging("maketagOut_V3", "Chute NO : " + PlangGIChuteNo);
                    ...
                    olog.logging("maketagOut_V3", "CountSKUtote : " + countTAG.ToString());
                    ...
                    for (int iLoop = 0; iLoop < countTAG; iLoop++)// Loop  ตาม QTY
                    {
                        ...
                        {
                            olog.logging("maketagOut_V3", "CheckCount break  ");
                        ...
                        foreach (wm_TagOutItem itemTAG in listTagoutItem.Where(c => c.TagOut_Status == 0).OrderBy(c => c.Volume).ThenBy(v => v.Product_Id).ThenBy(n => n.TagOutRef_No1))
                        {
                            ...
                            olog.logging("maketagOut_V3", "Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                            ...
                            if ((ToteRemainCM3 - itemTAG.Volume) < 0 || (oldPlanGI_No != ref_document_no))   // เปิดกล่องใหม่
                            {
                                ...
                                olog.logging("maketagOut_V3", " OpenTote  Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());


                                if ((oldLocation.Contains("PB") == true && itemTAG.TagOutRef_No1.Contains("PA") == true))
                                {

                                    olog.logging("maketagOut_V3", " PB continue  Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                    continue;
                                }
                                ...
                                if ((oldLocation.Contains("PA") == true && itemTAG.TagOutRef_No1.Contains("PB") == true))
                                {
                                    ...
                                    olog.logging("maketagOut_V3", " PA continue  Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                    continue;
                                }
                                ...
                                if (breakSKU == true)
                                {
                                    olog.logging("maketagOut_V3", " breakSKU  Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                ...
                                olog.logging("maketagOut_V3", " ToteRemainCM3 " + ToteRemainCM3.ToString() + " Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                ...
                                olog.logging("maketagOut_V3", " tagout_no " + tagout_no.ToString() + " Plan :" + ref_document_no + " / " + checkPlangGI + " Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                ...
                                olog.logging("maketagOut_V3", " db.WM_TagOutItem.Add  Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                            ...
                            else
                            {
                                ...
                                if ((oldLocation.Contains("PB") == true && itemTAG.TagOutRef_No1.Contains("PA") == true))
                                {
                                    ...
                                    olog.logging("maketagOut_V3", "Oldtote PB continue  Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                    continue;
                                }
                                ...
                                if ((oldLocation.Contains("PA") == true && itemTAG.TagOutRef_No1.Contains("PB") == true))
                                {
                                    ...
                                    olog.logging("maketagOut_V3", "Oldtote PA continue  Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                    continue;
                                }
                                ...
                                olog.logging("maketagOut_V3", "Oldtote ToteRemainCM3 " + ToteRemainCM3.ToString() + " Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                ...
                                olog.logging("maketagOut_V3", "Oldtote tagout_no " + tagout_no.ToString() + " Plan :" + ref_document_no + " / " + checkPlangGI + " Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                                ...
                                olog.logging("maketagOut_V3", " Oldtote  db.WM_TagOutItem.Add  Loop : " + icount.ToString() + " " + PRD.ToString() + " " + Loc.ToString() + " " + Tag.ToString());
                    ...
                    olog.logging("maketagOut_V3", " Carton  Loop Ref_Document_Index : " + item.RefDocIndex.ToString() );
                    ...
                    foreach (View_GoodsIssuecount_tag itxem in listgood_I_no)
                    {
                        ...
                        olog.logging("maketagOut_V3", " Carton  Loop Ref_Document_No : " + itxem.Ref_Document_No.ToString());
                        ...
                        for (int i = 0; i < count_item; i++)
                        {
                            olog.logging("maketagOut_V3", " Carton  Loop Ref_Document_No : " + itxem.Ref_Document_No.ToString() + " Product ID : " + itxem.Product_Id.ToString());
                            ...
                            olog.logging("maketagOut_V3", "Carton   db.WM_TagOut.Add(tagnew) : " + tagnew.TagOut_No.ToString()); 
                            //////////////////////
                            ///
                            Guid tagoutitem_index = Guid.NewGuid();
                            var tagout = new wm_TagOutItem();
                         ...
                         //   db.Entry(listgood_I_no).State = EntityState.Detached;
                            ...
                            olog.logging("maketagOut_V3", "Carton   db.WM_TagOutItem.Add(tagout) : " + tagnew.TagOut_No.ToString() );
                        }
                    }
                ...
                try
                {
                    ...
                    olog.logging("maketagOut_V3", msglog);
                    ...
                    try
                    {
                        olog.logging("maketagOut_V3", "s.sp_UpdateToteSize  : " + GI.GoodsIssue_Index.ToString ());

                        var pgi_index = new SqlParameter("@GoodsIssue_Index", GI.GoodsIssue_Index);
                        var resultTask = db.Database.ExecuteSqlCommand("EXEC sp_UpdateToteSize @GoodsIssue_Index", pgi_index);

                        olog.logging("maketagOut_V3", "E.sp_UpdateToteSize  : " + GI.GoodsIssue_Index.ToString());
                        ...
                        string cmd4 = "";
                        cmd4 += "       Update WMSDB_AMZ_Outbound_V3..wm_TagOut set   ";
                        cmd4 += "           TagOut_No = (select  top 1 TagOut_No from  WMSDB_AMZ_Outbound_V3..wm_TagOutItem TAOI where TAOI.TagOut_Index = WMSDB_AMZ_Outbound_V3..wm_TagOut.TagOut_Index )   ";

                        cmd4 += "       where Ref_Document_Index = '" + GI.GoodsIssue_Index + "'";
                        cmd4 += "       and LocationType = 'CartonFlowRack'    ";

                        string cmd5 = "";
                        cmd5 += "       Update [WMSDB_AMZ_Outbound_V3]..im_GoodsIssue set ";
                        ...
                        olog.logging("maketagOut_V3", "ExecuteSqlCommand R1 : " + cmd1 );
                        var r1 = db.Database.ExecuteSqlCommand(cmd1);
                        olog.logging("maketagOut_V3", "ExecuteSqlCommand R2 : " + cmd2);
                        var r2 = db.Database.ExecuteSqlCommand(cmd2);
                        olog.logging("maketagOut_V3", "ExecuteSqlCommand R3 : " + cmd3);
                        var r3 = db.Database.ExecuteSqlCommand(cmd3);
                        olog.logging("maketagOut_V3", "ExecuteSqlCommand R4 : " + cmd4);
                        var r4 = db.Database.ExecuteSqlCommand(cmd4);
                        olog.logging("maketagOut_V3", "ExecuteSqlCommand R5 : " + cmd5);
                        var r5 = db.Database.ExecuteSqlCommand(cmd5);


                        olog.logging("maketagOut_V3", "gen sp_CreatePickingplan");
                    ...
                    catch (Exception exxx)
                    {
                        ...
                        olog.logging("maketagOut_V3", msglog);
                        //throw exxx;
                        olog.logging("maketagOut_V3", "exxx inner - " + exxx.InnerException.Message.ToString());
                    }
                }
                catch (Exception exy)
                {
                    ...
                    olog.logging("maketagOut_V3", "exy inner - " + exy.InnerException.Message.ToString());
        ...
        public bool maketagOutTask()
        {
            ...
            try
            {
                ...
                foreach (im_GoodsIssue item in Gi_tag)
                {
                    ...
                    var tagout = maketagOut_V2(Gi_no);
